...
export const SEED_ISSUES: Issue[] = [
  ...
  { id: "i5", metric: "Fill Rate", locId: "st_274", severity: "p1", value: "98.6%", delta: "-0.6pp vs yest", threshold: "98–99%", transition: "above_to_below", transitionLabel: "Above → Below", what: "Trending down 3 days · approaching P0", fix: "S-04: pre-emptive restock + picker reshuffle", owner: "Vikram Singh, Manoj Verma", forUser: true, hypotheses: [{ h: "Stock-out trending up across snacks category", c: 0.55 }], actionDraft: "Pre-emptive restock · Reshuffle pickers", status: null, openedAt: tsMinus(3, 0), updatedAt: tsMinus(0, 14), comments: [] },
